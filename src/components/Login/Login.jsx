...
//   // Fetch user data from an Excel sheet
...
//       localStorage.setItem('user', JSON.stringify({ email, name, picture, isLoggedIn: true }));
...
//       setError('Failed to decode Google credentials. Please try again.');
//     }
//   };
...
function Login() {
  ...
  const handleGoogleLoginSuccess = (credentialResponse) => {
    try {
      ...
      const userData = { email, name, picture, isLoggedIn: true };
